    ...
    <main className="min-h-[60vh] pb-12">
      <div className="mx-auto max-w-3xl px-4 py-8 sm:px-6">
        ...
        <div className="mb-10 flex flex-col items-center text-center">
          <div className="mb-5 flex h-24 w-24 items-center justify-center rounded-full bg-accent-green anim-scale-in">
        ...
        >
          {/* Order ID Header */}
          <div className="flex flex-wrap items-center justify-between gap-3 bg-accent-teal/10 px-5 py-4 sm:px-6">
            <div>
        ...
        {/* ── Estimated Delivery ── */}
        <div
          className="mb-6 rounded-2xl border border-green-200 dark:border-green-900/30 bg-green-50 dark:bg-green-900/10 p-5 anim-fade-in"
          style={{ animationDelay: "550ms" }}
        >
          <div className="flex items-center gap-3">
            <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-accent-green/20">
            ...
            <div>
              ...
              <p className="text-sm text-green-700 dark:text-green-400 font-bengali">
          ...
          <div className="space-y-0">
            ...
            <div className="relative flex gap-4 pb-6">
              <div className="flex flex-col items-center">
                ...
                <div className="w-px flex-1 bg-accent-teal" />
              </div>
              <div className="pb-2">
                <p className="text-sm font-semibold text-accent-green font-bengali">
            ...
            <div className="relative flex gap-4 pb-6">
              <div className="flex flex-col items-center">
                <div className="flex h-8 w-8 animate-pulse items-center justify-center rounded-full bg-accent-teal text-white">
              ...
              <div className="pb-2">
                <p className="text-sm font-semibold text-accent-teal font-bengali">
                  প্রসেসিং চলছে
                </p>
              </div>
            </div>
        ...
        >
          ...
          <div className="flex flex-col items-center gap-2 sm:flex-row sm:justify-center sm:gap-6">
            <a
              ...
              className="flex items-center gap-2 text-sm text-gray-600 dark:text-gray-400 transition-colors hover:text-accent-teal"
            >
              <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor">
